...
## clases
YOLO_CLASSES = ('Maduro','Pinton', 'Inmaduro', 'Sobremaduro')


def unconvert(class_id, width, height, x, y, w, h, c):
    ...
    confi = float(c)
    return (class_id, xmin, xmax, ymin, ymax, confi)
    ...
    for i in range(len(ids)):
        ...
        if os.path.exists(target):
            ...
            for i in range(len(label_norm)):
                ...
                node_c = SubElement(node_bndbox, 'confi')
                node_c.text = str(new_label[5])
